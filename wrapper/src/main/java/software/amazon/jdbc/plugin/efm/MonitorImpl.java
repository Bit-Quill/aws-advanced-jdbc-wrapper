...
public class MonitorImpl implements Monitor {
  ...
  public MonitorImpl(
    ...
    this.contextsSizeGauge = telemetryFactory.createGauge("efm.contextsQueue.size", contexts.size());
  }
  ...
  ConnectionStatus checkConnectionStatus(final long shortestFailureDetectionIntervalMillis) {
    ...
    try {
      if (this.monitoringConn == null || this.monitoringConn.isClosed()) {
        ...
        TelemetryContext connectContext = telemetryFactory.openTelemetryContext("efm connect");
