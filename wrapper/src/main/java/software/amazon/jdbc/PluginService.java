...
public interface PluginService extends ExceptionHandler {
  ...
  /**
   * Establishes a connection to the given host using the given properties. If a non-default {@link ConnectionProvider}
   * has been set with {@link ConnectionProviderManager#setConnectionProvider} and
   * {@link ConnectionProvider#acceptsUrl(String, HostSpec, Properties)} returns true for the desired protocol, host,
   * and properties, the connection will be created by the non-default ConnectionProvider. Otherwise, the connection
   * will be created by the default ConnectionProvider. The default ConnectionProvider will be
