...
public interface ConnectionPlugin {
   ...
   *                            the past.
   * @param connectFunc         the function to call to continue the connect request down the connect pipeline.
   ...
   *                            physical connection to the database or has already established a physical connection in
   *                            the past.
   * @param forceConnectFunc    the function to call to continue the forceConnect request down the forceConnect
   *                            pipeline.
   * @return a {@link Connection} to the requested host.
   * @throws SQLException if there was an error establishing a {@link Connection} to the requested host.
   */
