...
public interface DynamicHostListProvider extends HostListProvider {
  ...
  HostRole getHostRole(HostSpec hostSpec) throws SQLException;

  HostRole getHostRole(String instanceName) throws SQLException;

  String getInstanceId(Connection conn);
}
